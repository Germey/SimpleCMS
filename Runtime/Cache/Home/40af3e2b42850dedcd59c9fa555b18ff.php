                ...
                <div class="content">
                    <div class="main-content">
                        ...
                        <div class="article-infos">
                            <?php if($info['extend']['found_time']): ?><span>成立时间：</span>
                                <span><?php echo ($info['extend']['found_time']); ?></span><?php endif; ?>
                        </div>
                        ...
                        <?php if($info['source_link']): ?><div class="more-details text-right">
                                <a href="<?php echo ($info['source_link']); ?>" class="btn btn-primary"target="_blank"><span class="glyphicon glyphicon-link" aria-hidden="true"></span> 项目详情</a>
                            </div><?php endif; ?>
                        <br />
                    </div>
                </div>
                <!-- 项目和基金的相关新闻 -->
<?php  $children_pages = $info['children_pages']; ?>
<?php if($children_pages): ?><div class="related-article">
        <div class="title">相关新闻</div>
        <?php if(is_array($children_pages)): foreach($children_pages as $key=>$one): ?><li><a href="<?php echo ($one['link']); ?>"><?php echo ($one['title']); ?></a><span class="pull-right"><?php echo substr($one['publish_time'],0,10);?></span></li><?php endforeach; endif; ?>
    </div><?php endif; ?>
                <div class="share">
...
<div class="proj-logo widget text-center">
	<img src="<?php echo thumb($info['thumb'], 300, 0);?>">
</div>
