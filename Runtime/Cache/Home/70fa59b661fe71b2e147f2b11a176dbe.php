...
<ul class="breadcrumb">
 ...
 $subchildren = D('Category')->getChildren($category['id']); ?>
        <?php if($subchildren): ?><div class="list-box">
                <div class="list-box-head"><?php echo ($category['title']); ?></div>
                <?php if(is_array($subchildren)): foreach($subchildren as $key=>$one): ?><a href="<?php echo ($one['link']); ?>">
        ...
        <div class="list-box">
            ...
            <?php  $abouts = D('Category')->getChildren('about'); ?>
            <?php if(is_array($abouts)): foreach($abouts as $key=>$one): ?><a href="<?php echo ($one['link']); ?>">
