    ...
    <div class="content-header">
        <div class="header-section">
            <form method="get">
                <table>
                    <tr>
                        <td><a href="<?php echo U('edit');?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> 新增标签</a></td>
                        <td>
                            <div class="input-group">
                              <input class="form-control input-sm" name="sname" value="<?php echo ($sname); ?>" placeholder="标签名" />
    ...
    <div class="block">
        <table id="general-table" class="table table-striped table-vcenter table-hover">
            ...
            <tbody>
                ...
                <?php if(is_array($tags)): foreach($tags as $key=>$one): ?><tr <?php if($hilight_id == $one['id']): ?>class="success"<?php endif; ?> >
                        <td nowrap><?php echo ($one['name']); ?></td>
                        <td><?php echo nl2br($one['description']);?></td>
                        <td><?php echo ($tag_content_map[$one['id']]); ?></td>
                        <td nowrap>
                            <?php if($login_user['role'] == 'manager'): ?><div class="btn-group btn-group-xs">
                                    ...
                                    <a href="<?php echo U('tag/delete?id='.$one['id']);?>" title="删除" class="btn btn-default ajaxlink" ask="确认要删除该记录?" >
