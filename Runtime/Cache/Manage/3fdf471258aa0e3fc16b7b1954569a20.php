...
<ul class="breadcrumb breadcrumb-top">
    ...
    <div class="block">
        <form action="<?php echo U('tag/save');?>" method="post" class="form-horizontal post_ajax_form">
            <table class="table table-noborder">
                <?php if(is_array($model_fields)): foreach($model_fields as $key=>$field): echo form_block($key, $field, $tag[$key]); endforeach; endif; ?>
            </table>
